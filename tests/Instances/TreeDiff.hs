...
-- instances
-------------------------------------------------------------------------------
instance (Eq a, Show a) => ToExpr (Condition a) where
    toExpr = defaultExprViaShow

instance (Show a, ToExpr b, ToExpr c, Show b, Show c, Eq a, Eq c, Eq b) =>
         ToExpr (CondTree a b c)

instance (Show a, ToExpr b, ToExpr c, Show b, Show c, Eq a, Eq c, Eq b) =>
         ToExpr (CondBranch a b c)

instance ToExpr AbiDependency where
    toExpr = defaultExprViaShow

instance ToExpr AbiHash where
    toExpr = defaultExprViaShow
...
instance ToExpr ComponentId where
    toExpr = defaultExprViaShow
...
instance ToExpr ExeDependency where
    toExpr = defaultExprViaShow

instance ToExpr Executable

instance ToExpr ExecutableScope where
    toExpr = defaultExprViaShow

instance ToExpr ExposedModule where
    toExpr = defaultExprViaShow

instance ToExpr Flag

instance ToExpr FlagName where
    toExpr = defaultExprViaShow
...
instance ToExpr LegacyExeDependency where
    toExpr = defaultExprViaShow

instance ToExpr LibVersionInfo where
    toExpr = defaultExprViaShow

instance ToExpr Library

instance ToExpr Mixin where
    toExpr = defaultExprViaShow
...
instance ToExpr PackageName where
    toExpr = defaultExprViaShow

instance ToExpr PkgconfigDependency where
    toExpr = defaultExprViaShow
...
instance ToExpr UnitId where
    toExpr = defaultExprViaShow

instance ToExpr UnqualComponentName where
    toExpr = defaultExprViaShow
